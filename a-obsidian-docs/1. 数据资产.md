...
为服务个人日频回测交易系统，数据资产层只维护必要对象；其他对象做软删除处理：物理表/视图保留，`meta.dataset_catalog.enabled=0`，前端列表置灰，source 更新不可选择。

- source 继续维护：`trade_calendar`、`all_stock_snapshot`、`bar_1d_raw`、`adjust_factor`。
- mart 继续维护：`universe_daily`、`bar_1d_qfq`。
- `security_master` 不再作为运行依赖；股票池和信号/回测所需 universe 使用选中交易日的 `source.all_stock_snapshot` 快照生成，避免引入最新静态资料造成未来函数。
- `dividend` 不再维护；前复权价格使用 `adjust_factor` 计算，当前个人回测目标不直接消费除权除息明细。
- 当前 `mart.bar_1d_qfq` 使用维护到最新的 `source.adjust_factor` 计算前复权价格，暂不做复权因子 `as_of_date` 版本化；它适合个人复盘和策略原型验证，严格无未来函数回测暂不保证复权因子口径。
...
| --- | --- | --- | --- | --- | ---: | --- |
| `security_master` | `source.security_master` | `query_stock_basic` | `all` | `0` | 10 | `` |
...
| `bar_5m_raw` | `source.bar_5m_raw` | `query_history_k_data_plus` | `equity_etf` | `0` | 70 | `2026-05-14` |
| `adjust_factor` | `source.adjust_factor` | `query_adjust_factor` | `equity_index_etf` | `1` | 80 | `2026-05-11` |
| `dividend` | `source.dividend` | `query_dividend_data` | `equity` | `0` | 90 | `2024-12-24` |
| `profit` | `source.profit` | `query_profit_data` | `equity` | `0` | 110 | `2024-06-30` |
| `operation` | `source.operation` | `query_operation_data` | `equity` | `0` | 120 | `2025-03-31` |
| `growth` | `source.growth` | `query_growth_data` | `equity` | `0` | 130 | `2025-06-30` |
| `balance` | `source.balance` | `query_balance_data` | `equity` | `0` | 140 | `2025-03-31` |
| `cash_flow` | `source.cash_flow` | `query_cash_flow_data` | `equity` | `0` | 150 | `2024-06-30` |
| `dupont` | `source.dupont` | `query_dupont_data` | `equity` | `0` | 160 | `2025-09-30` |
| `performance_express` | `source.performance_express` | `query_performance_express_report` | `equity` | `0` | 170 | `2026-05-07` |
| `forecast` | `source.forecast` | `query_forecast_report` | `equity` | `0` | 180 | `2026-04-30` |
| `deposit_rate` | `source.deposit_rate` | `query_deposit_rate_data` | `macro` | `0` | 210 | `2015-10-24` |
| `loan_rate` | `source.loan_rate` | `query_loan_rate_data` | `macro` | `0` | 220 | `2015-10-24` |
| `reserve_ratio` | `source.reserve_ratio` | `query_required_reserve_ratio_data` | `macro` | `0` | 230 | `2018-07-05` |
| `money_supply_month` | `source.money_supply_month` | `query_money_supply_data_month` | `macro` | `0` | 240 | `2026-04-01` |
| `money_supply_year` | `source.money_supply_year` | `query_money_supply_data_year` | `macro` | `0` | 250 | `2024-12-31` |
| `industry_snapshot` | `source.industry_snapshot` | `query_stock_industry` | `equity` | `0` | 260 | `2026-05-11` |
| `index_member_snapshot` | `source.index_member_snapshot` | `query_index_members` | `index_members` | `0` | 270 | `2026-05-04` |


## mart 数据集维护映射

| dataset_name | 物理对象 | 类型 | enabled | 维护状态 |
| --- | --- | --- | --- | --- |
| `universe_daily` | `mart.universe_daily` | TABLE | `1` | 维护 |
| `bar_1d_qfq` | `mart.bar_1d_qfq` | VIEW | `1` | 维护 |
| `bar_1d_hfq` | `mart.bar_1d_hfq` | VIEW | `0` | 不再维护 |
| `bar_1w` | `mart.bar_1w` | VIEW | `0` | 不再维护 |
| `bar_1m` | `mart.bar_1m` | VIEW | `0` | 不再维护 |
| `bar_1y` | `mart.bar_1y` | VIEW | `0` | 不再维护 |
| `bar_5m_qfq` | `mart.bar_5m_qfq` | VIEW | `0` | 不再维护 |
| `bar_5m_hfq` | `mart.bar_5m_hfq` | VIEW | `0` | 不再维护 |
| `bar_15m` | `mart.bar_15m` | VIEW | `0` | 不再维护 |
| `bar_30m` | `mart.bar_30m` | VIEW | `0` | 不再维护 |
| `bar_60m` | `mart.bar_60m` | VIEW | `0` | 不再维护 |
