...
class Settings:
    ...
    # Default off: nightly data refresh is moving to the NAS data asset service.
    auto_tushare_refresh_enabled: bool = os.getenv("AUTO_TUSHARE_REFRESH_ENABLED", "false").lower() in {
        "1",
        "true",
        "yes",
        "on",
